...
```powershell
Get-ChildItem .github\skills -Recurse -Filter *.md |
...
```powershell
Get-ChildItem .github\skills -Recurse -Filter *.md | ForEach-Object {
  $f = $_
